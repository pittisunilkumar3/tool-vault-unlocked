        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          <div className="md:col-span-4 space-y-4">
            ...
            <p className="text-gray-600">
              Access premium productivity tools with a simple subscription. Boost your workflow and save money.
            </p>
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#tools" className="text-gray-600 hover:text-brand-purple">Tools</a></li>
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 hover:text-brand-purple">Support</a></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-600 hover:text-brand-purple">Privacy Policy</a></li>
              <li><a href="#" className="text-gray-600 hover:text-brand-purple">Terms of Service</a></li>
              <li><a href="#" className="text-gray-600 hover:text-brand-purple">Cookie Policy</a></li>
              <li><a href="#" className="text-gray-600 hover:text-brand-purple">Security</a></li>
            </ul>
          </div>
        </div>
